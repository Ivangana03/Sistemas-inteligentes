...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //   newLaberinto.imprimirMatriz(null);
    // }
    ...
    //por cada fraccion de obstaculo se crea un nuevo archivo y se ejecuta 100 veces el algoritmo A*
    for (double fraccionObstaculos : fraccionesObstaculos) {
      ...
      try {
        ...
        if (numSoluciones != 0) {
          writer.write("\nLongitud promedio del camino: " + numIteraciones / numSoluciones);
        } else {
